...
const gtuPolicy = () => {
    return (
        ...
        <div className='header'>
            <h1>GTU Home Privacy Policy </h1><br />
            <p>This Privacy Policy was last updated on November 17, 2024.</p>
            ...
            <div className='tp_box'>
                ...
                <ul>
                    ...
                    <li>
                    <p><strong>Application</strong> refers to GTU Home - By Spike Point, the software program provided by the Company.</p>
                    </li>
                    <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Spike Point Infotech Pvt. Ltd, 204, Shreedhar Auram, Gandhinagar, Gujarat, India.</p>
                    </li>
                    <li>
                ...
                <h3>3. Collecting and Using Your Personal Data</h3>
                <div className='text-box'>
                ...
                <h3>6. Retention of Your Personal Data</h3>
                <div className='text-box'>
                ...
                <h3>7. Transfer of Your Personal Data</h3>
                <div className='text-box'>
